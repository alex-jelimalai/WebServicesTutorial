...
public class PredictionsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (key == null) {
            ...
            sendResponse(response, xml, isJsonFormat);
        }
        // Otherwise, return the specified Prediction.
            ...
            if (pred == null) { // no such Prediction
                ...
                sendResponse(response, predictions.toXML(pred), isJsonFormat);
            }
        }
    }
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            /*
             * To simplify the hack, assume that the PUT request has exactly two parameters: the id and either who or what. Assume, further, that the id comes
             * first. From the client side, a hash character # separates the id and the who/what, e.g., id=33#who=Homer Allision
             */
