 ...
 */
@WebFault(name = "VerbosityException", targetNamespace = "http://server.prediction.ch5.up_and_running.com/")
public class VerbosityException_Exception extends Exception {
    ...
    /**
     * @return returns fault bean: com.up_and_running.ch5.prediction.client.VerbosityException
     */
